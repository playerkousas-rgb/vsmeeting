...
> 最後更新：2026-09-17
> 目前 branch：`arena/01a0a9bb-vsmeeting`（v40：**深資童軍版** — 16 場＋7 套儀式卡＋獎章查閱＋AYP＋手冊AYP指南，前端零 SVG）
>
> **v40 快照（睇呢段就夠；下面 v19–v39 係歷史記錄）**
> - **深資童軍版全量重建**：16 場教案（會員章 c01–c06／肩章認識 c07–c09／肩章技能 c10–c16）、7 套儀式卡（無團呼）、深資制服 6 款（官網原圖 link-only）、獎章 20 項（會員章 11＋肩章 7＋獎章路 2，只查不記）、繩結 9 個、地圖 1:20,000、急救 5 種＋復原臥式；v39：底部第 5 格由營火會改做 AYP（概覽＋三級＋五科＋參加，只查不記）；v40：手冊加「AYP 領袖指南」分頁（什麼是AYP＋團員參加＋領袖參與＋成立執行處支部）。
