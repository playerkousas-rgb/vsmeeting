...
{ h:'1. 立正〔手冊第3章§2〕', dgm:'attn', dgmc:'立正・腳位 30 度・握拳（第3章§2）', d:'口令「<b>Alert！</b>」：兩腳掌平放地面、腳尖向外分開<strong>與中線成 30 度角</strong>（即兩腳尖之間約 60 度；舊版寫 45 度係錯）；雙膝蹬直；<strong>雙手握拳</strong>、手踭蹬直、母指指甲向前放喺食指上面、母指壓住褲骨；身體挺直、後顎繫貼衣領、眼望無限遠。⚠️ 手冊註明：Attention／Squad Shun／Parade Shun 動作跟立正一樣，但只適用於典禮、訓練班或其他制服團體，<strong>一般童軍集會不建議用</strong>——集會就嗌「立正（Alert）」。' },
      ...
      { h:'5. 睇齊〔第6章§4・中式「向右看——齊」〕', dgm:'dress', dgmc:'睇齊・Up—Two—Three—Move（第6章§4）', d:'排好之後先喊「向右——看」，隊員用<strong>右眼睺齊右邊隊員嘅左邊眼</strong>（中式口號），頭摆返正就喊「向前——看」。要領同手冊嘅 <i>Right — DRESS</i> 一樣：手踭貼住隔離隊員、身軀挺直、腳尖對齊；小隊長行前一步檢查。⚠️ 排長要調位置就用橫移，唔准長距離跑位。' },
  ...
  },
  {
    ...
    dgm:'howl',
    pending:1,
    figcap:'馬蹄鐵隊形（頂視圖）・開口位畀領袖起調・人人見到領袖 —— 圖解得返<strong>隊形</strong>呢部分有手冊依據（第8章§6）；團呼字句屬你團傳統，仍屬待核',
    duration:'約 1–2 分鐘',
    when:'正式開始及結束儀式',
...

  {
    ...
    icon:'🖐️',
    dgm:'formup',
    figcap:'集隊站位（頂視圖）：最先到嘅企 F1 做右標號員、C1／R1 跟住向左伸延；司令員喺最前排對上、相距 2250mm・小隊長企本隊最右、副隊長最左',
    rel:['c01','c08'],
