  ...
  body: [
    ...
    { n:9, side:'膊頭肩帶＋段章金帶',
      items:[
        ...
        '段章：活動策劃／社會服務／多元技能／戶外探險各完成一項即戴（第十一版）',
        '金帶：屬「榮譽童軍獎章」內項目——完成任一段章後，可開始考該段章之金帶（共四條：活動策劃／社會服務／多元技能／戶外探險），戴在段章之下'
      ],
      note:'肩章係深資身份標誌；段章由深資童軍團長（VSL）安排主考人及簽發；金帶屬「榮譽童軍獎章」，經團長協助由區總監／地域總監／青少年活動總監或其代表主考及簽發（詳見獎章查閱）。' }
  ]
};
...
UNIFORM.placementV2 = {
  ...
  groups:[
    ...
    { g:'帽・領巾・領帶・鞋襪', rows:[
      ...
      { item:'皮帶', where:'棕色皮帶（連童軍徽皮帶扣），皮帶扣緊扣在褲頭或裙頭中央', note:'3.6：戶外活動尼龍皮帶為童軍成員（小童軍除外）穿著戶外活動服裝時使用' },
...
UNIFORM.grooming = {
  ...
  items:[
    { t:'頭髮', d:'保持原來或自然的頭髮顏色；梳理整齊；男性長度不可觸及制服衣領或遮蓋耳朵，短髮者鬢角不可過半耳；女性長髮繞過耳背向後束起，髮長過肩以黑色髮型用品束成「低馬尾／低髮髻」放在帽後端下方，不可藏在帽內；戴帽期間額前頭髮不可外露。' },
    ...
    { t:'指甲與體味（領隊檢查用）', d:'集會前互相檢查時一併留意：指甲清潔、無異味、衫裙無污漬摺痕；呢樣唔係「扮靚」，係手冊對「整齊及清潔」嘅要求，亦係童軍自我形象嘅一部分。' }
  ]
};
